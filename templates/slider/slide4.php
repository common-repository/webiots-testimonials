        ...
        while( $loop->have_posts() ) {
            ...
            <div class="wi-slide" itemprop="review" itemscope itemtype="http://schema.org/Review">
                <div class="wi-testimonial"  itemprop="reviewBody">
                          <div class="wi-testimonial-content">
                                <div class="wi-user-pic">
                        <?php
                        if (has_post_thumbnail( $post->ID ) ) {
                            $image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'single-post-thumbnail');
                            ?>
                            <img src="<?php echo $image[0]; ?>"  itemprop="image" content="<?php echo $image[0]; ?>">
                        ...
                        ?>
                              ...
                              <div itemprop="author" itemscope itemtype="http://schema.org/Person">
                                  <h3 class="title"><b><?php echo get_post_meta($post->ID,"_testimonials_author_name", true); ?></b></h3></div>
                               <span class="post"><?php echo get_post_meta($post->ID, "_testimonials_designation", true); ?></span>
                    ...
                    <p class="wi-description">
                  <?php echo get_post_meta($post->ID,"_testimonials_description", true); ?></p>

                        <h6 class="wi-mb-3 wi-font-bold wi-grey-text"></h6>
