<section  itemscope itemtype="http://schema.org/Product">
    <div itemprop="name" content="product-reviews" class="single wi-slider">
        <?php
        $reviewCount = 0;
        $aggretated_rating = 0;
            ...
            <div class="wi-slide" itemprop="review" itemscope itemtype="http://schema.org/Review">
                <div class="wi-testimonial"  itemprop="reviewBody">
                    <div class="wi-testimonial">
                        <div class="wi-video-content">
                            <div class="wi-v-left">
                                <p class="wi-v-l-content"><i class="fa fa-quote-left"></i> <?php echo get_post_meta($post->ID,"_testimonials_description", true); ?></p>
                                <div class="wi-blue-line"></div>
                                <div>
                                    <ul class="wi-details_client">
                            ...
                            <div class="wi-v-right">
                                <?php

                                if((get_post_meta($post->ID, "_testimonials_youtube", true))){ ?>
                                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/<?php echo get_post_meta($post->ID, "_testimonials_youtube", true); ?>?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
                                    <?php
                                    ...
                                    ?>
                                    <img src="<?php echo $image[0]; ?>" class="center-block rounded-circle z-depth-1 img-fluid" itemprop="image" content="<?php echo $image[0]; ?>">
